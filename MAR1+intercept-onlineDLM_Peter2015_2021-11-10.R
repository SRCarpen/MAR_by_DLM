...
plot(tvec[2:nX],yhatmat[,1],type='l',lwd=3,col='deepskyblue',xlab='DOY',
     ylab='log10 Phycocyanin',main='Peter Lake 2015, r = 0.99')
points(tvec[2:nX],Xmat1[,1],type='p',pch=19,col='darkblue')
legend('topright',legend=c('One-step prediction','Observed'),lwd=c(3,NA),
...
plot(tvec[2:nX],yhatmat[,4],type='l',lwd=3,col='deepskyblue',xlab='DOY',
     ylab='log10 Chlorophyll',main='Peter Lake 2015, r = 0.97')
...
plot(yhatmat[,2],yhatmat[,3],type='p',pch=19,cex=0.8,col='darkblue',
     xlab='delta DO, r = 0.66',ylab='delta pH, r = 0.83',
     main='One-step predictions, Peter Lake 2015')
...
abline(v=180,lty=2,lwd=2,col='blue')
